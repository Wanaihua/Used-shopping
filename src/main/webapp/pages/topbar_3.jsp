...
<%
    ...
    if(request.getParameter("useid")!=null){
        ...
        a=(Integer)request.getAttribute("useid");
    }
%>
<input type="hidden" id="uuname" />
   ...
   <div class="bar_right" style="position:relative;margin-right:50px" id="info">
        <div class="post_order">
           <a href="${pageContext.request.contextPath}/pages/fabu.jsp?id=<%=a %>" target="_blank">发布商品
           </a>
        </div>         
        <div class="post_order">
           <a href="${pageContext.request.contextPath}/pages/mygoods.jsp?useid=<%=a %>" target="_blank">我的商品
           </a>
        </div>
        <div class="post_order">
           <a href="${pageContext.request.contextPath}/pages/shopcar.jsp?useid=<%=a %>" target="_blank">购物车
           </a>
        </div>        
        <div id="commonTopbar_my58menu" class="post_order">
           <a id="commonTopbar_tomy58" target="_blank" href="${pageContext.request.contextPath}/pages/myself.jsp?id=<%=a %>">个人信息
           </a>
        </div>
        <div class="post_order">
           <a href="${pageContext.request.contextPath}/pages/seeuser.jsp?useid=<%=a %>" target="_blank">查看用户
           </a>
        </div>
       <div class="post_order">
        ...
        <div class="post_order">
           <a href="${pageContext.request.contextPath}/pages/index.jsp">退出账号
           </a>
        </div>    
   </div> 
